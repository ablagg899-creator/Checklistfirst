# Chronicles of Asterfall

A touch-first 2D Android JRPG prototype built around the uploaded sprite sheets and map references. The game uses a classic pixel-adventure presentation rather than creature collection.

## Controls
- Left virtual analog: move in all directions
- A: talk / confirm
- B: open or close the menu
